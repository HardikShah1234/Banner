...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val expandableTextView =
            text_layout.findViewById<CustomTextView>(R.id.custom_text_view_deal)
        ...
        textView.setOnClickListener {
            textView.text =
                if (expandableTextView.isExpanded) getBoldString("Show More") else getBoldString("Show Less")
            expandableTextView.toggle()
        }

        //Banner deal
        val customTextViewDeal =
            text_layout_deal.findViewById<CustomTextView>(R.id.custom_text_view_deal)
        ...
        textViewDeal.setOnClickListener {
            textViewDeal.text =
                if (customTextViewDeal.isExpanded) {
                    getBoldString("Show More")
                } else {
                    getBoldString("Show Less")
                }
